...
const Nav = ({ spaced }) => (
  <NavBar spaced={spaced}>
    <NavList>
      ...
      <NavListItem noMargin>
        <NavLink
          ...
          target="_blank"
          rel="noreferrer"
          aria-label="view the source code of my Portfolio on Github.com"
        >
          Source Code.
        </NavLink>
      </NavListItem>
      {/* <NavListItem>
        <NavLink 
          href="https://www.ewanpetersen.com" 
          target="_blank" 
          rel="noreferrer" 
          aria-label="visit my husband's website on a new tab"
        >
          My Other Half.
        </NavLink>
      </NavListItem> */}
    ...
    <NavList>
      <NavListItem>
        <NavLink as={AnchorLink} white="true" to="/#projects">
          My Work.
        </NavLink>
      </NavListItem>
      <NavListItem noMargin>
        <NavLink as={Link} white="true" to="/contact">
          Say Hello.
        </NavLink>
      </NavListItem>
    </NavList>
